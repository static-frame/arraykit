...
from performance.reference.util import immutable_filter
from performance.reference.util import DTYPE_OBJECT
from performance.reference.util import array_deepcopy
    ...
    def _update_array_cache(self) -> None:
        if self._array_mutable is not None:
            if self._array is not None:
                ...
                array = np.empty(len_base + len(self._array_mutable), self._DTYPE)
