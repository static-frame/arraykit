...
class TestUnit(unittest.TestCase):
    ...
    def test_block_index_register_c(self) -> None:
        ...
        self.assertEqual(bi1.to_list(), [(0, 0), (1, 0), (2, 0), (2, 1)])
    ...
    def test_block_index_to_bytes_a(self) -> None:
        ...
        self.assertEqual(bi1.to_list(), [(0, 0), (0, 1), (0, 2), (1, 0), (1, 1)])
        data = bi1.to_bytes()
        bd = ctypes.sizeof(ctypes.c_ssize_t)
        post = [
            int.from_bytes(data[slice(i, i + bd)], sys.byteorder, signed=True)
    ...
    def test_block_index_iter_select_slice_a(self) -> None:
        ...
        self.assertEqual(
            list(bi1.iter_select((slice(None)))),
            [(0, 0), (0, 1), (1, 0), (2, 0), (2, 1), (2, 2), (2, 3), (2, 4)],
        )

        self.assertEqual(
            list(bi1.iter_select((slice(4, None)))), [(2, 1), (2, 2), (2, 3), (2, 4)]
        )
        ...
        self.assertEqual(
            list(bi1.iter_select((slice(1, 8, 2)))), [(0, 1), (2, 0), (2, 2), (2, 4)]
        )
    ...
    def test_block_index_iter_select_slice_b(self) -> None:
        ...
        self.assertEqual(
            list(bi1.iter_select((slice(7, 3, -1)))), [(2, 4), (2, 3), (2, 2), (2, 1)]
        )

        self.assertEqual(
            list(bi1.iter_select((slice(None, None, -1)))),
    ...
    def test_block_index_iter_select_slice_c(self) -> None:
        ...
        self.assertEqual(
            list(bi1.iter_select(slice(1, 5))), [(0, 1), (1, 0), (2, 0), (2, 1)]
        )

        self.assertEqual(
            list(reversed(bi1.iter_select(slice(1, 5)))),
            [(2, 1), (2, 0), (1, 0), (0, 1)],
        )
    ...
    def test_block_index_iter_select_slice_d(self) -> None:
        ...
        self.assertEqual(
            list(bi1.iter_select(slice(None))), [(0, 0), (0, 1), (0, 2), (1, 0)]
        )
        self.assertEqual(list(bi1.iter_select(slice(20, 24))), [])
        self.assertEqual(list(bi1.iter_select(slice(0, 100, 10))), [(0, 0)])
        self.assertEqual(list(bi1.iter_select(slice(0, 100, 3))), [(0, 0), (1, 0)])
    ...
    def test_block_index_iter_select_slice_e(self) -> None:
        ...
        self.assertEqual(
            list(bi1.iter_select(slice(11, None, -3))), [(1, 5), (1, 2), (0, 5), (0, 2)]
        )
        self.assertEqual(
            list(bi1.iter_select(slice(11, None, -4))), [(1, 5), (1, 1), (0, 3)]
        )
    ...
    def test_block_index_iter_select_boolean_a(self) -> None:
        ...
        self.assertEqual(list(bi1.iter_select(sel1)), [(0, 0), (1, 0), (2, 1), (2, 3)])

        sel2 = np.full(len(bi1), False)
        sel2[0] = True
        sel2[-1] = True
        self.assertEqual(list(bi1.iter_select(sel2)), [(0, 0), (2, 4)])
    ...
    def test_block_index_iter_select_boolean_c(self) -> None:
        ...
        self.assertEqual(
            list(bi1.iter_select(np.full(len(bi1), True))), [(0, 0), (0, 1), (1, 0)]
        )
    ...
    def test_block_index_iter_select_sequence_a(self) -> None:
        ...
        self.assertEqual(
            list(bi1.iter_select([0, -1, -2, -8])), [(0, 0), (2, 4), (2, 3), (0, 0)]
        )
        self.assertEqual(
            list(bi1.iter_select(np.array([0, -1, -2, -8]))),
            [(0, 0), (2, 4), (2, 3), (0, 0)],
        )
    ...
    def test_block_index_iter_contiguous_e2(self) -> None:
        ...
        self.assertEqual(
            list(bi1.iter_contiguous([6, 0, 7], reduce=True)), [(6, 0), (0, 0), (7, 0)]
        )
        self.assertEqual(
    ...
    def test_block_index_iter_contiguous_h2(self) -> None:
        ...
        self.assertEqual(
            post1,
            [(0, slice(0, 1, None)), (0, slice(2, 3, None)), (1, slice(1, 2, None))],
        )

        post3 = list(bi1.iter_contiguous(sel, ascending=True, reduce=True))
        self.assertEqual(post3, [(0, 0), (0, 2), (1, 1)])
